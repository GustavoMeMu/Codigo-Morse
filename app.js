...
const textoMorse1 = (morse) => {
    ...
    // Manejamos los espacios dobles o más para separarlos adecuadamente
...
document.getElementById('convertirTexto').addEventListener('click', () => {
    ...
    if (!validacion(texto)) {
        Swal.fire('Error', 'El texto contiene caracteres inválidos. Solo se permiten letras y espacios.', 'error');
        return;
    }
